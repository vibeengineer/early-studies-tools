...
INSERT INTO people (
  ...
  '{
    ...
    "SEO Description": "Full Episodes, Clips and the latest information about all of your favorite FOX shows.",
    "Technologies": "Akamai, Amazon SES, Gmail, Outlook, Google Apps, Microsoft Office 365, Zendesk, Salesforce, Sendgrid, ServiceNow, Taboola Newsroom, Chartbeat, Brightcove, Drupal, VueJS",
  ...
  '{
    ...
    "accomplishment_projects": [
      {
        "description": "Led cross-functional team to develop new audience segmentation model resulting in 32% increase in targeted ad efficiency",
      ...
      {
        "description": "Implemented predictive analytics framework for content performance optimization across digital platforms",
    ...
    "activities": [
      {
        ...
        "title": "Excited to share our latest research on viewer engagement patterns across streaming platforms. The data reveals surprising insights about Gen Z consumption habits that challenge traditional media metrics. #MediaAnalytics #DataScience"
      },
      {
        ...
        "title": "The Future of Audience Measurement in a Cross-Platform World: New Study Shows Emerging Patterns"
      }
    ],
    "articles": [],
    "background_cover_image_url": "https://media.licdn.com/dms/image/D5616AQHxYvFq1UG0Sg/profile-displaybackgroundimage-shrink_350_1400/0/1684789456123?e=1724976000&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
    "certifications": [
      {
        "authority": "Google",
    ...
    "education": [
      {
        ...
        "logo_url": "https://media.licdn.com/dms/image/C4D0BAQHiNSL4LkrMeA/company-logo_100_100/0/1519856053180?e=1727385600&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
      ...
      },
      {
        ...
        "grade": "Cum Laude",
        "logo_url": "https://media.licdn.com/dms/image/C4E0BAQFQr7xT6E3zSg/company-logo_100_100/0/1591052938267?e=1727385600&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
    ...
    "experiences": [
      ...
      },
      {
        ...
        "description": "Developed and led implementation of audience analytics strategy across digital platforms. Managed cross-functional projects to optimize content performance and audience engagement. Created predictive models for content performance and viewer retention.",
        "ends_at": { "day": 1, "month": 6, "year": 2021 },
        "location": "New York, New York, United States",
        "logo_url": "https://media.licdn.com/dms/image/C4D0BAQH-t2S4-cMNZQ/company-logo_100_100/0/1638831591606?e=1727385600&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
      ...
      },
      {
        ...
        "description": "Led analytics initiatives for MTV, Comedy Central, and Nickelodeon digital properties. Implemented audience segmentation strategies and content optimization frameworks.",
        "ends_at": { "day": 28, "month": 2, "year": 2018 },
        "location": "New York, New York, United States",
        "logo_url": "https://media.licdn.com/dms/image/C4D0BAQGYuFcGxzO8Tg/company-logo_100_100/0/1583932046901?e=1727385600&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
    ...
    "groups": [
      {
        "profile_pic_url": "https://media.licdn.com/dms/image/C5607AQFtgqKqfTGPUw/group-logo_image-shrink_92x92/0/1631007220687?e=1720882800&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
        "name": "Media Analytics Network",
        "url": "https://www.linkedin.com/groups/12345678"
      },
      {
        "profile_pic_url": "https://media.licdn.com/dms/image/C5607AQEeRta23_8JKA/group-logo_image-shrink_92x92/0/1631008330687?e=1720882800&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
    ...
    "profile_pic_url": "https://media.licdn.com/dms/image/D5603AQH8SzC7wyQn1A/profile-displayphoto-shrink_200_200/0/1689034567890?e=1724976000&v=beta&t=AbCdEfGhIjK1LmNoPqRsTuVwXyZ2A3B4C5D6E7F8G9H0",
    ...
    "volunteer_work": [
      {
        ...
        "description": "Mentoring early-career women in data science and analytics roles, providing guidance on career development and technical skills.",
        "logo_url": null
      }
    ],
    ...
    "industry": "Media Production",
    "extra": null,
    "interests": [ "Data Analytics", "Media Trends", "Audience Engagement", "Digital Transformation", "Content Strategy" ],
    "personal_emails": [],
    "personal_numbers": [],
    "skills": [ "Data Analytics", "Audience Measurement", "Media Analytics", "Tableau", "SQL", "Google Analytics", "Content Strategy", "Cross-platform Analytics", "Predictive Modeling", "Data Visualization", "Team Leadership", "A/B Testing", "Python", "R", "Audience Segmentation" ]
  }'
);
